...
export default function AuthErrorPage() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-background via-background to-muted/30 px-6 py-16 text-center">
      <div className="w-full max-w-md space-y-6 border border-border/60 bg-card/70 p-10 shadow-xl backdrop-blur">
        <div className="flex flex-col items-center gap-4">
          <span className="inline-flex items-center justify-center bg-destructive/10 p-3">

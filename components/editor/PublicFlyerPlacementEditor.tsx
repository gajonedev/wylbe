...
export function PublicFlyerPlacementEditor({
  ...
  const helperMessage = useMemo(() => {
    ...
    if (selectedZoneId) {
      return "Déposez une photo pour la zone sélectionnée, ajustez-la sur le canevas et téléchargez le tout.";
    }
    // if (zones.length === 0) {
      ...
      <div className="flex flex-col gap-2 border-b border-border/40 pb-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <p className="text-xl font-semibold uppercase tracking-wide">
            Ajouter votre photo dans la maquette
          </p>
        </div>
      ...
      <div className="flex flex-col gap-10 lg:flex-row">
        <div className="flex-1 space-y-4">
          <section className="border border-border/60 bg-card/60 p-4 shadow-sm backdrop-blur">
            <div className="flex max-sm:flex-row justify-between items-center gap-3">
              <div className="">
        ...
        <aside className="w-full lg:max-w-sm space-y-6">
          <section className="border border-border/60 bg-card/60 p-4 shadow-sm backdrop-blur">
            ...
            <div className="mt-4 space-y-3">
              {zones.length === 0 ? (
                <p className="text-sm text-muted-foreground">Aucun contour.</p>
              ) : (
                zones.map((zone) => {
...
export default PublicFlyerPlacementEditor;
